...
Primer copiar els documents de la carpeta on està aquest fitxer (ara mateix només printa un Hola per pantalla)
...
## _Crear un template com el que heu executat en el pas anterior:_
...
Un cop executat apareixerà un conjunt d'opcions diferents per a descarregar un template, jo he utilitzat "blank" per al projecte, però si més endavant ens veiem amb ganes d'utilitzar TypeScript, també ho podem provar.
